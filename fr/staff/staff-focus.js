async function getPlayer(player) {
    const response = await $.ajax({
        url: "https://example.com/getPlayer.php?player=" + player,
        method: "GET",
        dataType: "json",
    });
...
async function refreshDatabase(player, newPlayerPointDB) {
    try {
        const response = await $.ajax({
            url: "https://example.com/refreshDB.php?player=" + player + "&playerpoint=" + newPlayerPointDB,
            method: "GET",
            dataType: "json",
        });
        console.log(response);
...
async function getPointFromPlayer(player) {
    ...
    try {
        const response = await $.ajax({
            url: "https://example.com/getPoint.php?player=" + player,
            method: "GET",
            dataType: "json",
        });
